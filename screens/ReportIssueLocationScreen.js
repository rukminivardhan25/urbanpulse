...
export default function ReportIssueLocationScreen() {
  ...
  const handleSaveLocation = () => {
    ...
    // Return location data to ReportIssueScreen
    navigation.navigate('ReportIssue', { location: locationData });
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Select Issue Location</Text>
